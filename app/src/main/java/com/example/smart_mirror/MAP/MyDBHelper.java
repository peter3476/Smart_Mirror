...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "HairLossClinic.db";
    ...
    private void dataBaseCheck() {                      // 데이터베이스 점검
    ...
    @Override
    public synchronized void close() {                  // 데이터베이스 닫기
        if (mDataBase != null) {
            mDataBase.close();
        }
        super.close();
    ...
    private void dbCopy() {
        ...
        try {
            ...
            InputStream inputStream = mContext.getAssets().open("databases/HairLossClinic.db");
